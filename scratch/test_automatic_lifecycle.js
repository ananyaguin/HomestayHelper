...
async function testLifecycle() {
  ...
  try {
    ...
    const b2 = await bookingService.createGuestBooking(roomId, {
      guest_name: 'Primary Couple Guest',
      ...
      guests: [
        {
          name: 'Primary Couple Guest',
          phone: '9876543210',
          id_photo: 'data:image/png;base64,ID_PHOTO_PRIMARY_123',
          is_primary: true
        },
        {
          name: 'Secondary Guest Partner',
    ...
    await pool.query('DELETE FROM bookings WHERE id IN ($1, $2)', [b2.booking.id, b3.booking.id]);
